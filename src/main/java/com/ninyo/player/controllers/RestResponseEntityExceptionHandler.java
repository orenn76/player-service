...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handlePlayerException(Exception ex, HttpServletRequest req) {
        return handleException(ex, req, HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler({PlayerNotFoundException.class})
    public ResponseEntity<ErrorMessage> handlePlayerNotFoundException(Exception ex, HttpServletRequest req) {
        return handleException(ex, req, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler({ItemStreamException.class})
    public ResponseEntity<ErrorMessage> handleItemStreamException(Exception ex, HttpServletRequest req) {
        return handleException(ex, req, HttpStatus.INTERNAL_SERVER_ERROR);
    }
